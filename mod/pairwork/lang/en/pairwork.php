...
$string['modulename_help'] = 'pairwork help';
...
$string['pluginname'] = 'pairwork Activity';
...
$string['pairworksettings'] = 'pairwork settings';
$string['pairwork:addinstance'] = 'Add a new pairwork';
$string['pairwork:view'] = 'View pairwork';
$string['pairwork:preview'] = 'Preview pairwork';
$string['pairwork:itemview'] = 'View items';
$string['pairwork:itemedit'] = 'Edit items';
$string['id']='ID';
$string['name']='Name';
