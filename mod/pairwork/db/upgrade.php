...
function xmldb_pairwork_upgrade($oldversion) {
    ...
    // for demonstrative purposes and to show how the pairwork
    // iself has been upgraded.

    // For each upgrade block, the file pairwork/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field course to be added to pairwork
        ...
        // Define field intro to be added to pairwork
        $table = new xmldb_table('pairwork');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'pairwork');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to pairwork
        $table = new xmldb_table('pairwork');
        ...
        // Define field timemodified to be added to pairwork
        $table = new xmldb_table('pairwork');
        ...
        // Define index course (not unique) to be added to pairwork
        $table = new xmldb_table('pairwork');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'pairwork');
    }
