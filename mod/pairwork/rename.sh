...
find ./NEWMODULE -type f -exec sed -i "s|PAIRWORK|${MODULENAME}|g" {} \;
find ./NEWMODULE -type f -exec sed -i "s|MOD_PAIRWORK_|MOD_${MODULENAME}_|g" {} \;
find ./NEWMODULE -type f -exec sed -i "s|pairwork|${LMODULENAME}|g" {} \;
printf "enter the year, your name and email address on one line for the copyright notice. eg 2015 John Doe jdoe@email.com \n" 
read 2015 Andre Yamin andreyamin@gmail.com
find ./NEWMODULE -type f -exec sed -i "s|2015 Andre Yamin andreyamin@gmail.com|${2015 Andre Yamin andreyamin@gmail.com}_|g" {} \; 
